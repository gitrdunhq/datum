...
from datum.shared.logging.config import LoggingConfig
from datum.shared.logging.context import get_request_id
from datum.shared.logging.formatters import ConsoleFormatter, JSONFormatter
...
def get_logger(name: str) -> logging.Logger:
    ...
    Args:
        name: The logger name (will be prefixed with 'datum.' if not already).
