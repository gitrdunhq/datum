...
| G6 | Data plane | 0005/0013 | ledger/valkey/status modules (in-proc) | real Valkey checkpointer + libSQL ledger + per-run DB branch + metering | kill mid-run, resume from checkpoint; ledger rows queryable | P2 |
