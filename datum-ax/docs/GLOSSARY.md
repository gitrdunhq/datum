...
| **EPIC / epicBranch** | Self-contained feature + its branch and `docs/epics/<branch>/` artifact dir | **Adopt** — artifacts live under the epic; per-lane git worktrees (ADR-0012). |
